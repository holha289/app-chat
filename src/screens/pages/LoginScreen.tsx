    ...
    <ScrollView className="flex-1 bg-white">
      ...
      <View className={loginClassStyle.container}>
        <View className={loginClassStyle.header}>
          <Text className={loginClassStyle.title}>Đăng nhập</Text>
          <Text className={loginClassStyle.subtitle}>
            Hãy đăng nhập để kết nối, trò chuyện và khám phá những điều thú vị
            trong ứng dụng chat của chúng tôi.
          </Text>
        </View>
        <View className={loginClassStyle.inputContainer}>
          ...
          <TouchableOpacity
            ...
            onPress={handleLogin}
          >
            <Text className={classBtn.primaryText}>Đăng nhập</Text>
          </TouchableOpacity>
          <TouchableOpacity
            className={classBtn.secondary}
            onPress={handleCreateAccount}
          >
            <Text className={classBtn.outlineText}>Tạo tài khoản mới</Text>
          </TouchableOpacity>
        </View>
      </View>
    </ScrollView>
