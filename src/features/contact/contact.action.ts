...
const ContactActions = {
  getListFriendsRequest: createAction<{ offset?: number, limit?: number, q?: string }>(CONTACT_ACTIONS_TYPE.FRIENDS_REQUEST),
  ...
  getListGroupsRequest: createAction<{ offset?: number, limit?: number, q?: string }>(CONTACT_ACTIONS_TYPE.GROUPS_REQUEST),
  ...
  getListPendingRequest: createAction<{ offset?: number, limit?: number, q?: string }>(CONTACT_ACTIONS_TYPE.PENDING_REQUEST),
  ...
  createGroup: createAction<{ name: string; userIds: number[], avatar: string, callback: (error?: string) => void }>(CONTACT_ACTIONS_TYPE.CREATE_GROUP),
  createGroupSuccess: createAction<Groups>(CONTACT_ACTIONS_TYPE.CREATE_GROUP_SUCCESS),
